 ...
 *
 */
public class BpconlinePostJson implements JsonParser{

	private static final Log LOG = LogFactory.getLog(BpconlinePostJson.class);
	...
	public void executeParse(Map<String, Object> parsedata, String json,
		...
		if(obj instanceof Map){
			...
			if(map.containsKey("views")){
				parsedata.put(Constants.VIEW_CNT, map.get("views"));
			}
		}
