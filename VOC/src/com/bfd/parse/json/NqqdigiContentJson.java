 ...
 *
 */
public class NqqdigiContentJson implements JsonParser{

	private static final Log LOG = LogFactory.getLog(NqqdigiContentJson.class);
	...
	public void executeParse(Map<String, Object> parsedata, String json,
		...
		if (obj instanceof Map) {
			...
			if (map.containsKey("data")) {
				...
				parsedata.put(Constants.REPLY_CNT, dataMap.get("commentnum")); // 评论总数
			}
