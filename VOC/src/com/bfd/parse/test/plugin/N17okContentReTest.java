...
import com.bfd.parse.reprocess.N17okContentRe;
import com.bfd.parse.util.JsonUtil;

public class N17okContentReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://tech.17ok.com/news/1282/2017/0406/2583531.html";
		// 动态数据
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/N17ok_content_3.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new N17okContentRe(), tmplStr, face, outputFiled);
