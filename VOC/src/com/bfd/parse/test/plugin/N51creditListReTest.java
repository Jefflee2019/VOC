...
import com.bfd.parse.reprocess.N51creditListRe;
import com.bfd.parse.util.JsonUtil;

public class N51creditListReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url = "https://www.so.com/s?q=%E5%B0%8F%E7%B1%B3+site%3Alicai.51credit.com";
		// 动态数据
...
//		ajaxlist.add(null);
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/N51credit_list.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new N51creditListRe(), tmplStr, face,
				outputFiled);
