...
import com.bfd.parse.json.NhexunblogContentJson;
import com.bfd.parse.util.JsonUtil;

public class NhexunblogContentJsonTest {
...
//		String tmplStr = FileUtils.readFileToString(new File(""));
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new NhexunblogContentJson(), null, null, face, outputFiled);
