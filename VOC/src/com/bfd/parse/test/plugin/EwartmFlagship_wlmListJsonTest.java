...
import com.bfd.parse.json.EwartmFlagship_wlmListJson;
import com.bfd.parse.util.JsonUtil;

public class EwartmFlagship_wlmListJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://diviner.jd.com/diviner?&p=619029&sku=659016&lid=9&lim=60&ec=utf-8";
//		 动态数据
		 List<String> ajaxlist = new ArrayList<String>();
		 ajaxlist.add("http://diviner.jd.com/diviner?&p=619029&sku=659016&lid=9&lim=60&ec=utf-8");
		// 生成解析使用的bean
...
//		String tmplStr = FileUtils.readFileToString(new File("tmpl/Ejd_content_3.txt"));
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new EwartmFlagship_wlmListJson(), null, null, face, outputFiled);
