...
import com.bfd.parse.reprocess.Efeiniu_wlmListRe;
import com.bfd.parse.util.JsonUtil;

public class Efeiniu_wlmListReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://search.feiniu.com/?q=%E7%BE%8E%E8%B5%9E%E8%87%A3&page=1";
		// 动态数据
		...
		ParsePlugin testPlugin = new ParsePlugin(null, null, new Efeiniu_wlmListRe(), tmplStr, face, outputFiled);
