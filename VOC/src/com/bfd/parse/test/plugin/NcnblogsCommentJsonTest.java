...
import com.bfd.parse.json.NcnblogsCommentJson;
import com.bfd.parse.util.JsonUtil;

public class NcnblogsCommentJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url = "https://news.cnblogs.com/CommentAjax/GetComments?contentId=570628";
		// 动态数据
		List<String> ajaxlist = new ArrayList<String>();
		ajaxlist.add("https://news.cnblogs.com/CommentAjax/GetComments?contentId=570628");
		// 生成解析使用的bean
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new NcnblogsCommentJson(), null, tmplStr, face,
				outputFiled);
