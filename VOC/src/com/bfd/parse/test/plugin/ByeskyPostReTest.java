...
import com.bfd.parse.reprocess.ByeskyPostRe;
import com.bfd.parse.util.JsonUtil;

public class ByeskyPostReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://bbs.angeeks.com/thread-2611648-1-1.html";
//		String url1 = "http://cn.club.vmall.com/thread-11811653-1-1.html";
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Byesky_post_1.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new ByeskyPostRe(), tmplStr, face, outputFiled);
