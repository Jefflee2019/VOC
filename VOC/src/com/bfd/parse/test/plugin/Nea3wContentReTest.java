...
import com.bfd.parse.reprocess.Nea3wContentRe;
import com.bfd.parse.util.JsonUtil;

public class Nea3wContentReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
//		String url1 = "http://k.ea3w.com/152/1522778.html";
		String url1 = "http://news.ea3w.com/153/1531008.html";
		// 动态数据
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Nea3w_content_2.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new Nea3wContentRe(), tmplStr, face, outputFiled);
