...
import com.bfd.parse.reprocess.NtoutiaoAContentRe;
import com.bfd.parse.util.JsonUtil;

public class NtoutiaoAContentReTest {
	...
	public static void testDemo() throws Exception {
		...
		String url1 = "https://www.toutiao.com/a6570942197712028174/";
		// 动态数据
		...
		ParsePlugin testPlugin = new ParsePlugin(null, null, new NtoutiaoAContentRe(), null, face, outputFiled);
