...
import com.bfd.parse.reprocess.Eyhd_wlmListRe;
import com.bfd.parse.util.JsonUtil;

public class Eyhd_wlmListReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://search.yhd.com/c0-0/k%25E6%25B4%2597%25E5%258F%2591%25E4%25B9%25B3400g#page=1";
		// 动态数据
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Eyhd_wlm_list_10.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new Eyhd_wlmListRe(), tmplStr, face, outputFiled);
