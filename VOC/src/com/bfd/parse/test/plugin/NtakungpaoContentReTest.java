...
import com.bfd.parse.reprocess.NtakungpaoContentRe;
import com.bfd.parse.util.JsonUtil;

public class NtakungpaoContentReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
//		String url1 = "http://finance.takungpao.com/tech/q/2014/0726/2632375.html";
		String url1 = "http://news.takungpao.com/paper/q/2017/0411/3440042.html";
		// 动态数据
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Ntakungpao_content_2.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new NtakungpaoContentRe(), tmplStr, face, outputFiled);
