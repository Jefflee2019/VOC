...
import com.bfd.parse.reprocess.Eyhd_hwCommenRe;
import com.bfd.parse.util.JsonUtil;

public class Eyhd_hwCommentReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://item.yhd.com/squ/comment/getCommentDetail.do?productId=5089253&pagenationVO.currentPage=1&pagenationVO.preCurrentPage=0&pagenationVO.rownumperpage=10&filter.commentFlag=0&filter.sortType=6";
		// 动态数据
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Eyhd_hw_comment_1.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new Eyhd_hwCommenRe(), null, face, outputFiled);
