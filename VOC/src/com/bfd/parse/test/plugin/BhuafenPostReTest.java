...
import com.bfd.parse.json.BhuafenPostJson;
import com.bfd.parse.reprocess.BhuafenPostRe;
import com.bfd.parse.util.JsonUtil;

public class BhuafenPostReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://cn.club.vmall.com/thread-11819833-1-1.html";
//		String url1 = "http://cn.club.vmall.com/thread-11811653-1-1.html";
		// 动态数据
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Bhuafen_post_1.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, new BhuafenPostJson(), new BhuafenPostRe(), tmplStr, face, outputFiled);
