...
import com.bfd.parse.json.NyicaiListJson;
import com.bfd.parse.util.JsonUtil;

public class NyicaiListJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url = "http://www.yicai.com/api/search/?start=0&pagecount=10&type=2&contenttype=0&searchKeyWords=%25E5%258D%258E%25E4%25B8%25BA";
		// 动态数据
		List<String> ajaxlist = new ArrayList<String>();
		ajaxlist.add("http://www.yicai.com/api/search/?start=0&pagecount=10&type=2&contenttype=0&searchKeyWords=%25E5%258D%258E%25E4%25B8%25BA");
		// 生成解析使用的bean
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Nyicai_list.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, new NyicaiListJson(), null, tmplStr, face,
				outputFiled);
