...
import com.bfd.parse.json.NdgtleListJson;
import com.bfd.parse.json.NtoutiaoListJson;
import com.bfd.parse.util.JsonUtil;

public class NdgtleListJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "https://api.yii.dgtle.com/v2/forum-thread/thread?page=5&perpage=24&typeid=18";
		// 动态数据
...
//		String tmplStr = FileUtils.readFileToString(new File(""));
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new NdgtleListJson(), null, null, face, outputFiled);
