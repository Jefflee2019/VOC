...
import com.bfd.parse.json.EgomeCommentJson;
import com.bfd.parse.util.JsonUtil;

public class EgomeCommentJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://ss.gome.com.cn/item/v1/prdevajsonp/appraiseNew/9140046570/13/all/0/10/flag/appraise";
		// 动态数据
...
//		String tmplStr = FileUtils.readFileToString(new File(""));
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new EgomeCommentJson(), null, null, face, outputFiled);
