...
import com.bfd.parse.json.NbilibiliContentJson;
import com.bfd.parse.reprocess.NbilibiliContentRe;
import com.bfd.parse.util.JsonUtil;

public class NbilibiliContentReTest {
	...
	public static void testDemo() throws Exception {
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new NbilibiliContentJson(), new NbilibiliContentRe(), tmplStr, face, outputFiled);
