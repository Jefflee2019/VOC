...
import com.bfd.parse.json.Ejd_wlmContentJson;
import com.bfd.parse.util.JsonUtil;

public class Ejd_wlmContentJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "https://cd.jd.com/promotion/v2?skuId=1216716&area=19_1607_3155_0&shopId=1000002668&cat=1319,1523,7052";
//		 动态数据
		 List<String> ajaxlist = new ArrayList<String>();
		 ajaxlist.add("https://cd.jd.com/promotion/v2?skuId=1216716&area=19_1607_3155_0&shopId=1000002668&cat=1319,1523,7052");
		// 生成解析使用的bean
...
//		String tmplStr = FileUtils.readFileToString(new File("tmpl/Ejd_content_3.txt"));
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new Ejd_wlmContentJson(), null, null, face, outputFiled);
