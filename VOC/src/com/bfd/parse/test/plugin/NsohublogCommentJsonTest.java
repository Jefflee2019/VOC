...
import com.bfd.parse.json.NsohublogCommentJson;
import com.bfd.parse.util.JsonUtil;

public class NsohublogCommentJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://i.sohu.com/a/app/discuss/indexBlogList.htm?_input_encode=UTF-8&ids=blog_321046157_0_em91bGFuMTIzQHNvaHUuY29t&page=1&sz=10";
		// 动态数据
...
//		String tmplStr = FileUtils.readFileToString(new File(""));
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new NsohublogCommentJson(), null, null, face, outputFiled);
