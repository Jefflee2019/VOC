...
public class N21cnitListReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url = "https://www.so.com/s?q=%E5%8D%8E%E4%B8%BA%20site%3Abbs.huanqiu.com";
		// 动态数据
...
//		ajaxlist.add(null);
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/N21cnit_list.txt"));
		// 解析输出字段
		String outputFiled = "";
