...
import com.bfd.parse.reprocess.BhuafenListRe;
import com.bfd.parse.util.JsonUtil;

public class BhuafenListReTest {
	...
	public static void testDemo() throws Exception {
		...
		String url1 = "http://cn.club.vmall.com/forum-2698-1.html";
		// 动态数据
		...
		ParsePlugin testPlugin = new ParsePlugin(null, null, new BhuafenListRe(), tmplStr, face, outputFiled);
