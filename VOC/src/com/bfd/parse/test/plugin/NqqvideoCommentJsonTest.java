...
import com.bfd.parse.json.NqqvideoCommentJson;
import com.bfd.parse.util.JsonUtil;

public class NqqvideoCommentJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url = "https://coral.qq.com/article/2128893497/comment?commentid=0&reqnum=10";
		// 动态数据
		List<String> ajaxlist = new ArrayList<String>();
		ajaxlist.add("https://coral.qq.com/article/2128893497/comment?commentid=0&reqnum=10");
		// 生成解析使用的bean
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new NqqvideoCommentJson(), null, tmplStr, face,
				outputFiled);
