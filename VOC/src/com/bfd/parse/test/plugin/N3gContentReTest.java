...
import com.bfd.parse.reprocess.N3gContentRe;
import com.bfd.parse.util.JsonUtil;

public class N3gContentReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://mobile.3g.cn/NewsContents/index/newsid/2133961/pn/1?chn=shared";
		// 动态数据
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/N3g_content_1.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new N3gContentRe(), tmplStr, face, outputFiled);
