...
import com.bfd.parse.json.NwallstrListJson;
import com.bfd.parse.util.JsonUtil;

public class NwallstrListJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "https://api-prod.wallstreetcn.com/apiv1/search/article?query=华为&order_type=time&cursor=1&limit=20";
		// 动态数据
...
//		String tmplStr = FileUtils.readFileToString(new File(""));
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new NwallstrListJson(), null, null, face, outputFiled);
