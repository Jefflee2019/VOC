...
import com.bfd.parse.json.NyidianzixunCommentJson;
import com.bfd.parse.util.JsonUtil;

public class NyidianzixunCommentJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://www.yidianzixun.com/home/q/getcomments?docid=0GG0sT9P&count=30";
		// 动态数据
...
//		String tmplStr = FileUtils.readFileToString(new File(""));
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new NyidianzixunCommentJson(), null, null, face, outputFiled);
