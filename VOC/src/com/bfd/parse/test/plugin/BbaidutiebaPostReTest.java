...
import com.bfd.parse.reprocess.BbaidutiebaPostRe;
import com.bfd.parse.util.JsonUtil;

public class BbaidutiebaPostReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "https://tieba.baidu.com/p/5561289758?pn=1";
//		String url1 = "http://tieba.baidu.com/p/4891203081";
		// 动态数据
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Bbaidutieba_post_1.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new BbaidutiebaPostRe(), tmplStr, face, outputFiled);
