...
import com.bfd.parse.json.NjiemianCommentJson;
import com.bfd.parse.util.JsonUtil;

public class NjiemianCommentJsonTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url = "http://a.jiemian.com/index.php?m=comment&a=getlistCommentP&aid=918480";
...
//		String tmplStr = FileUtils.readFileToString(new File("tmpl/Nhinews_content_2.txt"));
		...
		ParsePlugin testPlugin = new ParsePlugin(null, new NjiemianCommentJson(), null, null, face,
				outputFiled);
