...
import com.bfd.parse.reprocess.Ejd_wlmContentRe;
import com.bfd.parse.util.JsonUtil;

public class Ejd_wlmContentReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
//		String url1 = "https://item.jd.com/11225432781.html";
		String url1 = "https://item.jd.com/548573.html";
		// 动态数据
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Ejd_wlm_content_10.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new Ejd_wlmContentRe(), tmplStr, face, outputFiled);
