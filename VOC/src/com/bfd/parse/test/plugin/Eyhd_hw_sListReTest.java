...
import com.bfd.parse.reprocess.Eyhd_hw_sListRe;
import com.bfd.parse.util.JsonUtil;

public class Eyhd_hw_sListReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://search.yhd.com/searchPage/c0-0/mbname-b/a-s1-v4-p1-price-d0-f0b-m1-rt0-pid-mid0-color-size-kvivo/?isGetMoreProducts=0";
		// 动态数据
		...
		ParsePlugin testPlugin = new ParsePlugin(null, null, new Eyhd_hw_sListRe(), null, face, outputFiled);
