...
import com.bfd.parse.reprocess.NeastmoneyblogContentRe;
import com.bfd.parse.util.JsonUtil;

public class NeastmoneyblogContentReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "http://blog.eastmoney.com/kafukano1/blog_400642813.html";
//		String url1 = "http://blog.eastmoney.com/jinshi095/blog_570926870.html";
		// 动态数据
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Neastmoneyblog_content_1.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new NeastmoneyblogContentRe(), tmplStr, face, outputFiled);
