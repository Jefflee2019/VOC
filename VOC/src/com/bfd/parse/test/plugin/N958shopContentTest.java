...
import com.bfd.parse.reprocess.N958shopContentRe;
import com.bfd.parse.util.JsonUtil;

public class N958shopContentTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url = "http://gc.958shop.com/detail/67057.html";
		// 动态数据
...
//		ajaxlist.add(null);
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/N958shop_content_1.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new N958shopContentRe(), tmplStr, face,
				outputFiled);
