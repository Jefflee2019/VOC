...
import com.bfd.parse.reprocess.NcnnicListRe;
import com.bfd.parse.util.JsonUtil;

public class NcnnicListReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url = "http://search.cnnic.cn/cnnic_search/showResult.jsp?sChar=%25E5%258D%258E%25E4%25B8%25BA&pageNo=1";
		// 动态数据
...
//		ajaxlist.add(null);
		...
		// 模板
		String tmplStr = FileUtils.readFileToString(new File("tmpl/Ncnnic_list.txt"));
		// 解析输出字段
		String outputFiled = "";
		ParserFace face = new ParserFace("test");
		// 执行解析流程
		// 参数分别是 预处理插件,json插件,后处理插件,模板,ParseFace,输出字段
		ParsePlugin testPlugin = new ParsePlugin(null, null, new NcnnicListRe(), tmplStr, face,
				outputFiled);
