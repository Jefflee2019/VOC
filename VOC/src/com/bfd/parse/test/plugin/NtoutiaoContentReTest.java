...
import com.bfd.parse.reprocess.NtoutiaoContentRe;
import com.bfd.parse.util.JsonUtil;

public class NtoutiaoContentReTest {
	...
	public static void testDemo() throws Exception {
		// 要抓取链接
		String url1 = "https://www.toutiao.com/a6609161334300869133";
//		String url1 = "http://www.toutiao.com/a6419535946938089729/";
		// 动态数据
...
//		String tmplStr = FileUtils.readFileToString(new File(""));
		...
		ParsePlugin testPlugin = new ParsePlugin(null, null, new NtoutiaoContentRe(), null, face, outputFiled);
